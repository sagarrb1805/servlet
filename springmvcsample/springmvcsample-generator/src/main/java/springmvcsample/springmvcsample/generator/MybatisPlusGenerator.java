package springmvcsample.springmvcsample.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "springmvcsample.springmvcsample";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/springmvcsample-model"),
        mapper("/springmvcsample-dao"),
        mapperxml("/springmvcsample-web"),
        service("/springmvcsample-service"),
        web("/springmvcsample-web"),
        ;
